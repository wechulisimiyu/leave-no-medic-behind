...
const styled, { createGlobalStyle } = require('styled-components')
...
const {
    ...
    MadeWithLove,
    themeGet,
} = require('@adminjs/design-system')
const { useTranslation, ReduxState } = require('adminjs')
